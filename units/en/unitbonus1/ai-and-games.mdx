...
It **doesn't matter how intelligent your videogame AI is if the player doesn't understand it**. One of the simplest and most effective ways of communicating intelligence is simply to have NPCs say what they think aloud -  a concept known in game development as a *'bark'*.  
