...
- 📅: 04/17: Unit 2: AI Tools for Game Developers 🎨
- 📅: 04/24: Unit 3: Creating an horror alien game from scratch with Unity and AI tools 👽
- 📅: TBA Unit 4: Running locally Large Language Models (LLama2...) in Unity
- 📅: TBA Demo Unit 2
