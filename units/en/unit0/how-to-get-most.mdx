...
While following our demos step by step is essential to learn, **but don't hesitate to get hands-on by modifying them**. Experimentation is a powerful learning tool 🧪.
...
Please ask your question on our Discord server, #ml-4-games-dev.
