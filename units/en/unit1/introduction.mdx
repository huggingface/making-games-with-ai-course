...
And you're going to make this demo, where a **smart robot understands your orders and performs them**.
...
- [Unity Sentis library](https://docs.unity3d.com/Packages/com.unity.sentis@latest), the neural network inference library that allows us to **run our AI model directly inside our game**.

- The [Hugging Face Sharp Transformers](https://github.com/huggingface/sharp-transformers)): a Unity plugin with utilities to **run Transformer 🤗 models more easily in Unity games**.
...
And I also worked on a stealth game, where you guide your character to sneak in a party and steal some stuff.
...
You'll be also able to improve the demo, [by adding a Speech To Text model to command the robot with your voice!](https://thomassimonini.substack.com/p/building-ai-driven-voice-recognition)
