...
To illustrate this, first you'll dive into *NPC-Playground* created through the collaboration of the [Cubzh](https://cu.bzh/) and [Gigax](https://github.com/GigaxGames/gigax) teams, showcasing the potential of smart LLM-powered NPCs.

You can play the demo 👉 [here](https://huggingface.co/spaces/cubzh/ai-npcs)
